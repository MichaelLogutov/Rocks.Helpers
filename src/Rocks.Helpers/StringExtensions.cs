...
namespace Rocks.Helpers
{
    public static class StringExtensions
    {
        ...
        /// <summary>
        ///     Returns part of the string that goes after the last occurrence of <paramref name="search"/> string.
        /// </summary>
        [CanBeNull]
        public static string RightPart ([CanBeNull] this string value,
                                        [CanBeNull] string search,
                                        StringComparison comparisonType = StringComparison.Ordinal)
        {
            if (string.IsNullOrEmpty (value) || string.IsNullOrEmpty (search))
                return null;

            var index = value.LastIndexOf (search, comparisonType);
            if (index < 0)
                return null;
            ...
            var result = value.Substring (index);
        ...
        /// <summary>
        ///     Returns part of the string that goes before the first occurrence of <paramref name="search"/> string.
        /// </summary>
        [CanBeNull]
        public static string LeftPart ([CanBeNull] this string value,
                                        [CanBeNull] string search,
                                        StringComparison comparisonType = StringComparison.Ordinal)
        {
            if (string.IsNullOrEmpty (value) || string.IsNullOrEmpty (search))
